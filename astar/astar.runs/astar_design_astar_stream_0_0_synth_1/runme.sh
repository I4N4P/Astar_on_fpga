...
HD_PWD='C:/Users/dawid/SDUP/astar_pathfinder_co-processor_on_fpga/astar/astar.runs/astar_design_astar_stream_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log astar_design_astar_stream_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source astar_design_astar_stream_0_0.tcl

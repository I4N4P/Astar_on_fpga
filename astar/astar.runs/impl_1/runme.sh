...
HD_PWD='C:/Users/dawid/SDUP/astar_pathfinder_co-processor_on_fpga/astar/astar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log astar_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source astar_design_wrapper.tcl -notrace
